...
public class CameraSource implements Camera.AutoFocusCallback {
...
//                previewFpsRange[Camera.Parameters.PREVIEW_FPS_MAX_INDEX]);
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                logE("soporta focus mode");
            } else {
                Log.e(TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes() != null && parameters.getSupportedFlashModes().contains(
                ...
                logW("Camera flash mode: " + mFlashMode + " is not supported on this device.");
            }
        }
    ...
    public void focusOnTouch(Rect focusRect, Rect meteringRect) {
        if (mCamera != null) {
